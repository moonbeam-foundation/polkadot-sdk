...
use sp_trie::{empty_child_trie_root, LayoutV0, LayoutV1, TrieConfiguration, PrefixedMemoryDB};
use std::{
	any::{Any, TypeId},
...
impl Externalities for BasicExternalities {
	...
	fn child_storage_root(
		...
		if let Some((data, child_info)) = self.overlay.child_changes_mut(child_info.storage_key()) {
			...
			crate::in_memory_backend::new_in_mem::<Blake2Hasher, PrefixedMemoryDB<Blake2Hasher>>()
